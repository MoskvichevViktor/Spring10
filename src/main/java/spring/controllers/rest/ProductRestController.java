package spring.controllers.rest;
...
import spring.persistence.mapper.ProductConverter;
...
public class ProductRestController {
    ...
    public ResponseEntity<?> getAllProducts(@RequestParam(defaultValue = "1") Integer pageIndex,
        ...
        Page<Product> page = productService.findAllFilteredPaged(minPrice, maxPrice, partTitle,
